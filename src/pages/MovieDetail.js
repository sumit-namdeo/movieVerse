...
export const MovieDetail = () => {
    ...
    const image = movie.poster_path ? `https://image.tmdb.org/t/p/w400/${movie.poster_path}` : placeholder;
    ...
    return (
        <section className='flex justify-around flex-wrap max-w-7xl mx-auto py-7 p-4'>
            ...
            <div className='max-w-2xl text-gray-600 text-lg dark:text-white'>
                ...
                <div className='text-left mt-4'>
                    ...
                    <p className='my-4  '>
                        ...
                        <a href={`https://www.imdb.com/title/${movie.imdb_id}`} className='color-bluetext-emerald-600' target='_blank' rel='noreferrer'> {movie.imdb_id}</a>
                    </p>
                </div>
